...
public class servlet2 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<h1>Accessing config parameters - Servlet 2</h1>");
		...
		out.print("<h1>Accessing context parameters - Servlet 2</h1>");
		out.print("<br>Driver = " + conf.getInitParameter("driver"));
		out.print("<br>URL = " + conf.getInitParameter("url"));
		
		out.print("<br><br><a href = servlet1>Trigger Servlet 1</a>");
